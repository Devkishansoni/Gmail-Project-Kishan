...
import chevronleft from './icons/chevron_left_black_24dp.svg'
import chevronright from './icons/chevron_right_black_24dp.svg'
import key from './icons/keyboard_black_24dp.svg'
import arrowdown from './icons/arrow_drop_down_black_24dp.svg'
          ...
          <div class="inbox-menu-group">
            ...
            <div class="inbox-btn-group" >
              <button class="btn-alt">
                <img src={check} alt="Select" class="btn-icon-sm btn-icon-alt btn-icon-hover" />
              </button>
          ...
          <div class="inbox-menu-group">
            ...
            <div class="inbox-menu-pagination-btn">
              <button class="btn btn-nofill btn-pagination">
                <img src={chevronleft} alt="Newer" class="btn-icon-sm btn-icon-alt" />
              </button>

              <button class="btn btn-pagination">
                <img src={chevronright} alt="Older" class="btn-icon-sm btn-icon-alt btn-icon-hover" />
              </button>
            </div>

            <div class="inbox-btn-group" >
              <button class="btn-alt">
                <img src={key} alt="Input tools on/off" class="btn-icon-sm btn-icon-alt" />
              </button>

              <button class="btn-sm btn-alt">
                <img src={arrowdown} alt="Select input tool" class="btn-icon-sm btn-icon-alt" />
              </button>
            </div>
                ...
                <div class="footer-item">
                  ...
                  <a href="#" class="footer-link footer-text-sm">
                    ...
                    <div class="footer-group">
                      ...
                      <span>
                        <img src={open} alt="Google drive storage" class="btn-icon-alt btn-icon-sm" />
                      </span>
                    </div>
